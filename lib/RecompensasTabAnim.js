...
// numérico válido > 0), mostramos ese número fijo con un pulse sutil de
// "configurado" (sin rotar). Si todavía no configuró nada, ciclamos entre
// 10/15/20/30 como teaser de los valores tipicos.
...
export default function RecompensasTabAnim({ tabId, systemType = 'stars', active = true, discountPercent = null }) {
  ...
  return (
    <span style={{
      display: 'inline-flex', flexDirection: 'column', alignItems: 'flex-sta