...
// `benefix:bizAnswer` está compartido con el card del perfil, así que
  ...
  return (
    <div style={{ marginBottom: 12 }}>
      <div style={{
        ...
        padding: '10px 12px',
        borderRadius: 12,
        background: 'linear-gradient(135deg, rgba(254,80,0,0.10), rgba(189,75,248,0.10))',
        ...
        <div style={{
          ...
          flexShrink: 0,
          boxShadow: '0 3px 10px rgba(189,75,248,0.40)',
        }}>
        ...
        <button onClick={accept} aria-label="Sí, registrar mi negocio"
          style={{
            ...
            boxShadow: '0 3px 10px rgba(189,75,248,0.35)',
            letterSpacing: '.02em',
          }}>
          Sí
        </button>
