        ...
        {step === 'qr' && (
          <>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 16 }}>
              <div style={{ padding: 14, background: '#FFFFFF', borderRadius: 18, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 32px rgba(0,0,0,0.45)' }}>
                {qrValue ? (
                  <QRCodeSVG value={qrValue} size={220} fgColor="#0a0a0a" bgColor="#FFFFFF" level="H" />
                ) : (
                  <div style={{ width: 220, height: 220, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(0,0,0,0.45)', fontSize: 12, textAlign: 'center', padding: 16 }}>
