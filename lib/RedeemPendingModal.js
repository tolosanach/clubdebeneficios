      ...
      >
        ...
        <div style={{ textAlign:'center', marginBottom:22 }}>
          <div style={{
            ...
            display:'flex', alignItems:'center', justifyContent:'center',
            margin:'0 auto 14px',
            boxShadow:'0 12px 32px rgba(189,75,248,0.50)',
          }}>
        ...
        <div style={{
          ...
          <div style={{ display:'flex', alignItems:'center', gap:6, fontSize:13, color:'rgba(255,255,255,0.65)' }}>
            <UnitIcon size={13} {...(isStars ? { strokeWidth:0, fill:'#BD4BF8' } : { strokeWidth:2, color:'#BD4BF8' })} />
            <span>{unitTxt}</span>
        ...
        <div style={{
          background:'linear-gradient(135deg, rgba(189,75,248,0.12) 0%, rgba(254,80,0,0.08) 100%)',
          border:'1px solid rgba(189,75,248,0.40)',
          borderRadius:14,
          padding:'14px 16px',
          marginBottom:18,
          ...
          <>
            <button
              ...
              style={{
                ...
                cursor:'pointer',
                display:'flex', alignItems:'center', justifyContent:'center', gap:10,
                boxShadow:'0 8px 24px rgba(189,75,248,0.45)',
                marginBottom:10,
              }}
            >
        ...
        <div style={{
          ...
          <CheckCircle size={13} color="rgba(189,75,248,0.85)" strokeWidth={2.4} style={{ flexShrink:0, marginTop:1 }} />
          <span>
