export const rubros = {
  peluquerias: {
    ...
    beneficiosRubro: [
      ...
      { icono: 'message-circle', titulo: 'Reactivá clientes inactivos',        desc: 'Clufix detecta quién no vino en 30 días y le manda un mensaje por WhatsApp automáticamente. (Plan Pro)' },
    ],
  ...
  farmacias: {
    ...
    beneficiosRubro: [
      ...
      { icono: 'message-circle', titulo: 'Reactivá al que no vino',       desc: '"Hace 30 días que no te vemos, tenés X puntos esperándote." El mensaje lo manda Clufix solo. (Plan Pro)' },
    ],
  ...
  indumentaria: {
    ...
    beneficiosRubro: [
      ...
      { icono: 'message-circle', titulo: 'WhatsApp a clientes que no vuelven',    desc: 'Clufix detecta quién no compró en 30 días y les manda un mensaje automático con incentivo. (Plan Pro)' },
    ],
  ...
  restaurantes: {
    ...
    beneficiosRubro: [
      ...
      { icono: 'message-circle', titulo: 'Reactivá clientes inactivos',      desc: '"Hace 3 semanas que no te vemos, tenés X estrellas esperándote." Lo manda Clufix solo. (Plan Pro)' },
    ],
  ...
  gimnasios: {
    ...
    beneficiosRubro: [
      ...
      { icono: 'message-circle', titulo: 'Aviso al socio que no viene',         desc: '"Hace 2 semanas que no te vemos, tenés X estrellas esperándote." Lo manda Clufix solo. (Plan Pro)' },
    ],
  ...
  jugeterias: {
    ...
    beneficiosRubro: [
      ...
      { icono: 'message-circle', titulo: 'Recordatorio previo a fechas clave',   desc: '"Se acerca el Día del Niño, tenés X puntos para canjear." Lo manda Clufix solo. (Plan Pro)' },
    ],
