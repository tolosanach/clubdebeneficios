    ...
    <div style={{ fontFamily:FN, overflowX:'hidden' }}>
      ...
      <section style={{ background:V1, padding:`80px ${px}`, textAlign:'center', color:'#fff' }}>
        <FadeIn>
          ...
          <h1 style={{ fontFamily:FM, fontSize:'clamp(2.2rem,5vw,3.6rem)', fontWeight:900, letterSpacing:'-2.5px', lineHeight:1.08, margin:'0 0 24px', maxWidth:680, marginLeft:'auto', marginRight:'auto', whiteSpace:'pre-line' }}>
            {rubro.heroTitle}
          </h1>
