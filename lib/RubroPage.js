    ...
    <div style={{ fontFamily:FN, overflowX:'hidden' }}>
      ...
      <section style={{ background:V1, padding:`80px ${px}`, textAlign:'center', color:'#fff' }}>
        <FadeIn>
          ...
          <h1 style={{ fontFamily:FM, fontSize:'clamp(2.2rem,5vw,3.6rem)', fontWeight:800, letterSpacing:'-3px', lineHeight:1.08, margin:'0 0 24px', maxWidth:680, marginLeft:'auto', marginRight:'auto', whiteSpace:'pre-line' }}>
            {rubro.heroTitle}
          </h1>
        ...
        <div style={{ display:'grid', gridTemplateColumns: mobile ? '1fr' : 'repeat(3, 1fr)', gap:24, maxWidth:960, margin:'0 auto' }}>
          {rubro.flujo.map((paso, i) => (
            <FadeIn key={i} delay={i * 80}
              ...
              <h3 style={{ margin:'0 0 12px', color:V1, fontSize:'1.05rem', fontWeight:800, fontFamily:FM }}>{paso.titulo}</h3>
