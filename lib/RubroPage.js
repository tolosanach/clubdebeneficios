    ...
    <div style={{ fontFamily:FN, overflowX:'hidden' }}>
      ...
      <section style={{ background:V1, padding:`80px ${px}`, textAlign:'center', color:'#fff' }}>
        <FadeIn>
          ...
          <h1 style={{ fontFamily:FM, fontSize:'clamp(2.8rem,8vw,5rem)', fontWeight:900, letterSpacing:'0px', textTransform:'uppercase', lineHeight:1.05, margin:'0 0 24px', maxWidth:680, marginLeft:'auto', marginRight:'auto', whiteSpace:'pre-line' }}>
            {rubro.heroTitle}
          </h1>
        ...
        <div style={{ display:'grid', gridTemplateColumns: mobile ? '1fr' : 'repeat(3, 1fr)', gap:24, maxWidth:960, margin:'0 auto' }}>
          {rubro.flujo.map((paso, i) => (
            <FadeIn key={i} delay={i * 80}
              ...
              <h3 style={{ margin:'0 0 12px', color:V1, fontSize:'1.05rem', fontWeight:900, fontFamily:FM, textTransform:'uppercase' }}>{paso.titulo}</h3>
