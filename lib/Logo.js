...
// Logo — wordmark unificado de Clufix.
//
...
// - El alt es siempre "Clufix" — el wordmark es texto puro a nivel visual.

const SRC = {
  white:  '/brand/logo-clufix-wordmark-white.svg',
  violet: '/brand/logo-clufix-wordmark.svg',
  full:   '/brand/logo-clufix.svg',
}
