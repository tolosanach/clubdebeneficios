...
import {
  ...
  IconCheck, IconX, IconCrown, IconPercentage, IconMessages, IconFlame,
...
const PLANS = [
  {
    ...
    features: [
      ...
      { label:'Cupones de descuento',     ok:false, founderOnly:true },
      { label:'Días bonus ×2',            ok:false, founderOnly:true },
      { label:'Soporte prioritario',      ok:false, founderOnly:true },
      { label:'WhatsApp semi-automático', ok:false, founderOnly:true },
      { label:'Reactivar inactivos',      ok:false, founderOnly:true },
      { label:'Clientes ilimitados',      ok:false, founderOnly:true },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      { label:'Días bonus ×2',            ok:true },
      { label:'Soporte prioritario',      ok:true },
      { label:'WhatsApp semi-automático', ok:true },
            ...
            <FadeIn key={plan.name} delay={i * 80}
              ...
              <div style={{ padding:'24px 28px 32px', display:'flex', flexDirection:'column', flex:1 }}>
                ...
                <div style={{ borderTop:'1px solid rgba(34,0,51,0.1)', margin:'20px 0', flex:1 }}>
                  {plan.features.map(f => {
                    const showCheck = f.ok || f.founderOnly
                    return (
                      <div key={f.label} style={{ padding:'8px 0', borderBottom:'1px solid rgba(34,0,51,0.06)' }}>
                        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
                          {showCheck
                            ? <IconCheck size={16} stroke={2.5} color={f.founderOnly ? PK : DK} />
                            : <IconX     size={16} stroke={2.5} color='rgba(34,0,51,0.25)' />
                          }
                          <span style={{ fontSize:'0.88rem', color: showCheck ? DK : 'rgba(34,0,51,0.4)', fontFamily:FN }}>{f.label}</span>
                        </div>
                        {f.founderOnly && (
                          <div style={{ marginTop:4, marginLeft:26 }}>
                            <span style={{ background:'rgba(255,25,159,0.08)', border:'1px solid rgba(255,25,159,0.25)', borderRadius:100, color:PK, fontSize:'0.62rem', fontWeight:700, padding:'2px 8px', display:'inline-block', fontFamily:FN }}>
                              ✦ incluido hasta 31/08
                            </span>
                          </div>
                        )}
                      </div>
                ...
                {plan.name === 'Pro'
                  ? <button onClick={onLoginClick} style={{ background:LT, color:DK, width:'100%', textAlign:'center', marginTop:8, padding:'0.9rem 2.25rem', borderRadius:100, fontWeight:700, fontSize:'0.95rem', border:'none', cursor:'pointer', fontFamily:FN }}>
                      Tu plan actual
                    </button>
