...
function Nav({ onLoginClick }) {
  return (
    <nav style={{ height:72, background:'rgba(15,8,32,0.96)', borderBottom:'1px solid rgba(255,255,255,0.07)', display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 clamp(16px, 5vw, 48px)', fontFamily:FN }}>
