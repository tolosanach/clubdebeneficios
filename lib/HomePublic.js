...
const h2style  = { fontFamily:FN, fontSize:'clamp(1.8rem, 4vw, 2.4rem)', fontWeight:900, letterSpacing:'-2px', lineHeight:1.1, margin:0 }
    ...
    <div style={{ fontFamily:FN, overflowX:'hidden' }}>
      ...
      <section style={{ background:V1, padding:`80px ${px}`, textAlign:'center', color:'#fff' }}>
        <FadeIn>
          ...
          <h1 style={{ fontFamily:FN, fontSize:'clamp(2.4rem,6vw,4rem)', fontWeight:900, letterSpacing:'-2.5px', lineHeight:1.05, margin:'0 0 24px', maxWidth:700, marginLeft:'auto', marginRight:'auto' }}>
