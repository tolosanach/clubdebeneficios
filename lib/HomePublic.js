...
const h2serif = {
  fontFamily:SERIF, fontWeight:600, letterSpacing:'-0.025em',
  fontSize:'clamp(2rem, 4.6vw, 3.2rem)', lineHeight:1.05, margin:0, color:INK,
}
...
function Nav({ onLoginClick, onLogoClick, onGoPanel, user }) {
  ...
  return (
    <nav style={{
      ...
      <button onClick={onLogoClick} style={{ background:DARK, border:'none', borderRadius:10, padding:'7px 13px', cursor:'pointer', display:'flex', alignItems:'center' }}>
        <img src="/clufix_logo.svg" alt="Clufix" style={{ height:26, width:'auto', display:'block' }} />
      </button>
  ...
  return (
    <section style={{ position:'relative', minHeight:'100svh', overflow:'hidden', background:BG, padding:'clamp(96px,14vh,150px) clamp(16px,5vw,48px) 0' }}>
      ...
      <div style={{ position:'relative', zIndex:10, maxWidth:1200, margin:'0 auto', textAlign:'center' }}>
        ...
        <FadeIn delay={80}>
          <h1 style={{
            fontFamily:SERIF, fontWeight:700, letterSpacing:'-0.035em',
            fontSize:'clamp(2.6rem, 8vw, 6rem)', lineHeight:0.98, margin:'0 auto 22px', maxWidth:920, color:'#fff',
          }}>
          ...
          {MERCHANT_STEPS.map((s, i) => {
            ...
            return (
              <FadeIn key={s.num} delay={i * 120} style={{ padding:'32px clamp(4px,2vw,28px) 36px', borderBottom:`1px solid ${LINE}` }}>
                ...
                <h3 style={{ fontFamily:SERIF, fontWeight:600, fontSize:'1.5rem', letterSpacing:'-0.02em', color:INK, margin:'0 0 10px' }}>{s.title}</h3>
    ...
    <section className="lx-noise" style={{ background:DARK, padding:'clamp(72px,11vh,120px) clamp(16px,5vw,48px)', textAlign:'center', position:'relative' }}>
      <div style={{ position:'relative', zIndex:2, maxWidth:900, margin:'0 auto' }}>
        <FadeIn>
          ...
          <h2 style={{ fontFamily:SERIF, fontWeight:700, fontSize:'clamp(2.4rem,6vw,4.2rem)', lineHeight:1.0, margin:'0 0 18px', color:CREAM, letterSpacing:'-0.03em' }}>
            Tres meses Pro.<br />
  ...
  return (
    <section className="lx-noise" style={{ background:DARK, padding:'clamp(88px,14vh,150px) clamp(16px,5vw,48px) clamp(72px,10vh,110px)', textAlign:'center', position:'relative' }}>
      <div style={{ position:'relative', zIndex:2 }}>
        <FadeIn>
          <h2 style={{ fontFamily:SERIF, fontWeight:700, fontSize:'clamp(2.6rem,7vw,4.6rem)', color:CREAM, letterSpacing:'-0.03em', margin:'0 0 16px', lineHeight:1 }}>
