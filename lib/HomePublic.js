...
function Nav({ onLoginClick }) {
  return (
    <nav style={{ height:'96px', background:DK, borderBottom:`1px solid rgba(237,213,246,0.12)`, display:'flex', alignItems:'center', justifyContent:'space-between', padding:'0 1.5rem', fontFamily:FN }}>
      <a href="/" style={{ flexShrink:0, textDecoration:'none', display:'flex', alignItems:'center' }}>
        <img src="/clufix_logo.svg" alt="Clufix" style={{ height:'96px', width:'auto', display:'block' }} />
      </a>
    ...
    <div style={{ fontFamily:FN, overflowX:'hidden', isolation:'isolate' }}>
      ...
      <section style={{ display:'grid', gridTemplateColumns: mobile ? '1fr' : '1fr 1fr' }}>
        <FadeIn style={{ background:LT, padding:`${sectionPy} ${px}` }}>
          <span style={{ display:'block', fontSize:'0.72rem', fontWeight:700, textTransform:'uppercase', letterSpacing:'3px', color:PK, marginBottom:14 }}>COMERCIO</span>
          <h2 style={{ ...h2style, color:DK, fontWeight:900 }}>VOS LO ARMÁS.</h2>
          <p style={{ marginTop:20, color:DK, lineHeight:1.7, maxWidth:440, fontWeight:400 }}>
            Tu club listo en 2 minutos. Tus reglas, tus premios, tu forma.
          </p>
        </FadeIn>
        <FadeIn style={{ background:DK, padding:`${sectionPy} ${px}` }} delay={100}>
          <span style={{ display:'block', fontSize:'0.72rem', fontWeight:700, textTransform:'uppercase', letterSpacing:'3px', color:PK, marginBottom:14 }}>CLIENTE</span>
          <h2 style={{ ...h2style, color:LT, fontWeight:900 }}>VOS LO DISFRUTÁS.</h2>
          <p style={{ marginTop:20, color:LT, lineHeight:1.7, maxWidth:440, fontWeight:400 }}>
      ...
      <section id="como-funciona">
        ...
        <div style={{ display:'grid', gridTemplateColumns: mobile ? '1fr' : '1fr 1fr' }}>
          <div style={{ background:LT, padding:`48px ${px}` }}>
            <p style={{ fontWeight:700, fontSize:'1.1rem', margin:'0 0 8px', color:DK }}>Tu club está listo.</p>
            <p style={{ color:'rgba(34,0,51,0.55)', margin:0 }}>El primer cliente ya puede entrar.</p>
          </div>
          <div style={{ background:DK, padding:`48px ${px}` }}>
            <p style={{ fontWeight:700, fontSize:'1.1rem', margin:'0 0 8px', color:WH }}>El cliente llega.</p>
...
// ─── Static data ──────────────────────────────────────────────────────────────
const STEPS = [
  { num:'01', tag:'El comercio', title:'ENTRÁS CON GOOGLE',          desc:'Un click y ya tenés tu cuenta. Sin formularios, sin tarjeta.',                                                                                                                                                                                    light:true,  visual:'🔑' },
  { num:'02', tag:'El comercio', title:'ARMÁS TU CLUB',              desc:'Elegís cómo premiar — por visita o por lo que gastan. Cargás tus premios, activás un cupón de descuento para la próxima compra y podés sumar días con puntos dobles para mover los momentos flojos. Todo se puede cambiar cuando quieras.',       light:false, visual:'⚙️' },
  { num:'03', tag:'El comercio', title:'PONÉS EL QR EN TU LOCAL',    desc:'Imprimís el display, lo ponés en el mostrador. Tu club está abierto.',                                                                                                                                                                                light:true,  visual:'📌' },
  { num:'04', tag:'El cliente',  title:'ESCANEA Y ENTRA',            desc:'Apunta la cámara, se registra en segundos y recibe un beneficio de bienvenida.',                                                                                                                                                                      light:false, visual:'📱' },
  { num:'05', tag:'El cliente',  title:'SUMA EN CADA VISITA',        desc:'Ve su progreso en el celular. Cada vez que viene, se acerca más a su premio.',                                                                                                                                                                        light:true,  visual:'⭐' },
  { num:'06', tag:'El cliente',  title:'LLEGA AL PREMIO Y CANJEA',   desc:'El sistema avisa cuando está listo. El cliente elige, vos confirmás. Simple.',                                                                                                                                                                        light:false, visual:'🎁' },
]
