  ...
  return (
    <nav style={{ position:'sticky', top:0, zIndex:100, height:68, background:'#fff', borderBottom:'1px solid #f0eaff', display:'flex', alignItems:'center', padding:'0 clamp(16px, 5vw, 48px)', gap:32, fontFamily:FN }}>
      ...
      <div style={{ flex:1, display:'flex', alignItems:'center', gap:28 }}>
        <a href="#planes"  style={{ color:'#1A0050', fontSize:'0.9rem', fontWeight:500, textDecoration:'none' }}>Precios</a>
        <a href="#rubros"  style={{ color:'#1A0050', fontSize:'0.9rem', fontWeight:500, textDecoration:'none' }}>Rubros</a>
      </div>
      <div style={{ display:'flex', gap:10, alignItems:'center' }}>
        <button onClick={onLoginClick} style={{ color:V1, padding:'0.5rem 1rem', borderRadius:100, border:'1.5px solid #ddd', background:'none', cursor:'pointer', fontFamily:FN, fontWeight:500, fontSize:'0.9rem' }}>
          Iniciar sesión
        </button>
        <button onClick={onLoginClick} style={{ background:V1, color:'#fff', padding:'0.5rem 1.25rem', borderRadius:100, border:'none', cursor:'pointer', fontFamily:FN, fontWeight:700, fontSize:'0.9rem' }}>
          Registrarse
        </button>
      </div>
    </nav>
