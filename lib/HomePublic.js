    ...
    <div style={{ fontFamily:FN, overflowX:'hidden', isolation:'isolate' }}>
      ...
      <section style={{ display:'grid', gridTemplateColumns: mobile ? '1fr' : '1fr 1fr' }}>
        <FadeIn style={{ background:LT, padding:`${sectionPy} ${px}` }}>
          ...
          <h2 style={{ ...h2style, color:DK, fontWeight:900 }}>VOS LO OFRECÉS.</h2>
          <p style={{ marginTop:20, color:DK, lineHeight:1.7, maxWidth:440, fontWeight:400 }}>
            Configurá tu club en 2 minutos. Estrellas, puntos, premios. Tus reglas.
          </p>
        </FadeIn>
        <FadeIn style={{ background:DK, padding:`${sectionPy} ${px}` }} delay={100}>
          ...
          <h2 style={{ ...h2style, color:LT, fontWeight:900 }}>VOS LO GANÁS.</h2>
          <p style={{ marginTop:20, color:LT, lineHeight:1.7, maxWidth:440, fontWeight:400 }}>
            Escaneá, acumulá y canjeá tus premios. Sin descargar nada.
          </p>
        </FadeIn>
      </section>
