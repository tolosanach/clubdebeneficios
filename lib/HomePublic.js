  ...
  return (
    <div style={{ fontFamily:FN, overflowX:'hidden', isolation:'isolate' }}>
      ...
      <section style={{ background:'#220033', padding:`80px ${px}`, textAlign:'center' }}>
        <FadeIn>
          <h1 style={{ fontFamily:FM, fontSize:'clamp(3.5rem,10vw,6rem)', fontWeight:400, letterSpacing:'0px', textTransform:'uppercase', lineHeight:1.1, margin:'0 0 20px', maxWidth:800, marginLeft:'auto', marginRight:'auto' }}>
            <span style={{ display:'block', color:'#FFFFFF' }}>EL LUGAR DONDE</span>
            <span style={{
              display:'flex',
              alignItems:'center',
              justifyContent:'center',
              minHeight:'clamp(190px, 25vw, 220px)',
              overflow:'hidden',
              position:'relative',
            }}>
              <span style={{
