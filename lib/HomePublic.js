    ...
    <div style={{ fontFamily:FN, overflowX:'hidden', isolation:'isolate' }}>
      ...
      <section style={{ background:DK, borderTop:'1px solid rgba(237,213,246,0.12)', padding:`${sectionPy} ${px}`, textAlign:'center' }}>
        <FadeIn style={{ marginBottom:48 }}>
          ...
          <h2 style={{ ...h2style, color:WH, marginBottom:'1rem' }}>
            Ser primero<br />tiene sus ventajas.
          </h2>
          <p style={{ fontFamily:FN, fontSize:'0.95rem', color:'rgba(255,255,255,0.65)', maxWidth:560, margin:'0 auto 0', lineHeight:1.7 }}>
            Todos los comercios que se registren durante el período de lanzamiento acceden al plan Pro sin cargo hasta el 31 de agosto de 2026. Sin tarjeta, sin letra chica.
          </p>
        </FadeIn>
...
const FOUNDER_BENEFITS = [
  ...
  { icon:<IconMessages    size={24} stroke={1.5} />, label:'WhatsApp automático'     },
