...
function Footer() {
  return (
    <footer style={{ background:WH, borderTop:'1px solid rgba(34,0,51,0.1)', padding:'1.5rem 2rem', display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:'1rem', fontFamily:FN }}>
      <img src="/clufix_logo.svg" alt="Clufix" height={28} style={{ display:'block' }} />
      <span style={{ fontSize:'0.78rem', color:'rgba(34,0,51,0.5)' }}>© 2026 · clufix.com.ar · General Pico, La Pampa</span>
    </footer>
  )
}
...
export default function HomePublic({ onLoginClick }) {
  ...
  return (
    <div style={{ fontFamily:FN, overflowX:'hidden', isolation:'isolate', paddingBottom:'calc(80px + env(safe-area-inset-bottom, 0px))' }}>
