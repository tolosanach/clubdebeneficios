...
export default function HomePublic({ onLoginClick }) {
  ...
  return (
    <div style={{ fontFamily:FN, overflowX:'hidden' }}>
      ...
      {/* ── 2. Hero ─────────────────────────────────────────────────────── */}
      <section style={{ background:'#1A0050', padding:`80px ${px}`, textAlign:'center', color:'#fff' }}>
        <FadeIn>
          ...
          <h1 style={{ fontFamily:"'Tilt Warp', sans-serif", fontSize:'clamp(2.8rem,8vw,5rem)', fontWeight:400, letterSpacing:'0px', textTransform:'uppercase', lineHeight:1.05, margin:'0 0 24px', maxWidth:700, marginLeft:'auto', marginRight:'auto' }}>
            <span style={{ color:'#FF199F' }}>Tus clientes ya existen.</span><br />
            <span style={{ color:'#ffffff' }}>Hacelos volver.</span>
          </h1>
          <p style={{ fontSize:'clamp(1rem,2vw,1.15rem)', color:'rgba(255,255,255,0.7)', maxWidth:520, margin:'0 auto 36px', lineHeight:1.65 }}>
            El sistema de fidelización más simple del país. Sin hardware, sin complicaciones.
          </p>
          <div style={{ display:'flex', gap:14, justifyContent:'center', flexWrap:'wrap' }}>
            <button onClick={onLoginClick} style={{ ...btnPk, background:'#FF199F', color:'#ffffff' }}>Crear mi club gratis</button>
