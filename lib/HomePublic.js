  ...
  return (
    <div style={{ fontFamily:FN, overflowX:'hidden', isolation:'isolate' }}>
      ...
      <section style={{ background:'#220033', padding:`80px ${px}`, textAlign:'center' }}>
        <FadeIn>
          <h1 style={{ fontFamily:FM, fontSize:'clamp(3.5rem,10vw,6rem)', fontWeight:400, letterSpacing:'0px', textTransform:'uppercase', lineHeight:1.05, margin:'0 0 24px', maxWidth:700, marginLeft:'auto', marginRight:'auto' }}>
            <span style={{ color:'#FFFFFF' }}>TUS CLIENTES</span><br />
            <span style={{ color:'#FF199F' }}>YA EXISTEN.</span>
          </h1>
          <p style={{ fontSize:'clamp(1rem,2vw,1.15rem)', color:'rgba(255,255,255,0.7)', maxWidth:520, margin:'0 auto 36px', lineHeight:1.65 }}>
            Fidelizalos con Clufix.
          </p>
