  ...
  return (
    <div style={{ fontFamily:FN, overflowX:'hidden', isolation:'isolate' }}>
      ...
      <section id="como-funciona">
        {STEPS_COMMERCE.map((step) => {
          const dark = !step.light
          return (
            <FadeIn key={step.num} style={{ background: dark ? DK : LT }}>
              <div style={{ display:'grid', gridTemplateColumns: mobile ? '1fr' : '1fr 1fr', maxWidth:1100, margin:'0 auto', padding:`${sectionPy} ${px}`, gap:40, alignItems:'center' }}>
                <div>
