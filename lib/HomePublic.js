...
export default function HomePublic({ onLoginClick }) {
  ...
  return (
    <div style={{ fontFamily:FN, overflowX:'hidden', isolation:'isolate' }}>
      ...
      {/* ── COMERCIO block ──────────────────────────────────────────────── */}
      {renderBlock(true, 'COMERCIO', 'VOS LO ARMÁS.', 'Tu club listo en 2 minutos. Tus reglas, tus premios, tu forma.', STEPS_COMMERCE, 0, 'como-funciona')}
      ...
      {/* ── CLIENTE block ───────────────────────────────────────────────── */}
      {renderBlock(false, 'CLIENTE', 'VOS LO DISFRUTÁS.', 'Escaneá, acumulá y canjeá. Sin descargar nada.', STEPS_CLIENT, 3)}
