...
// Color del segmento activo segun contexto. Violeta para merchant,
// fucsia para cliente — matchea al QR central del BottomNavV2.
const ROLE_GRADIENT = {
  merchant: 'linear-gradient(135deg, #7C3AED, #BD4BF8)',
  client:   'linear-gradient(135deg, #DB2777, #F472B6)',
}
...
export default function ContextSwitchPill({ activeContext, onChange, visible = true }) {
  ...
  const activeGradient = ROLE_GRADIENT[activeContext] || ROLE_GRADIENT.client
