      ...
      >
        ...
        >
          <span style={{
            ...
            <QrCode size={24} color="#8B5CF6" strokeWidth={2.2} />
          </span>
        ...
        <button
          ...
          style={{
            ...
            marginBottom: 18,
            borderRadius: 16,
            background: 'linear-gradient(135deg, rgba(254,80,0,0.12), rgba(189,75,248,0.12))',
            border: '1px solid rgba(189, 75, 248, 0.4)',
            color: '#fff',
            cursor: 'pointer',
            fontFamily: 'inherit',
            textAlign: 'left',
        ...
        >
          <span style={{
            ...
            display: 'inline-flex', alignItems: 'center', justifyContent: 'center',
            flexShrink: 0,
            boxShadow: '0 4px 12px rgba(189,75,248,0.40)',
          }}>
