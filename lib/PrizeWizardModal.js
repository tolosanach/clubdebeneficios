      ...
      <div style={{ padding: '14px 22px 6px', flexShrink: 0, position: 'relative', zIndex: 1, textAlign: 'center' }}>
        {stepHero?.Icon && (
          <div style={{
            ...
            background: 'linear-gradient(135deg, rgba(189,75,248,0.18), rgba(124,58,237,0.10))',
            border: '1px solid rgba(189,75,248,0.40)',
            marginBottom: 12,
            boxShadow: '0 8px 24px -8px rgba(189,75,248,0.55)',
          }}>
            <stepHero.Icon size={24} color={C.v} strokeWidth={2.2} />
          </div>
        )}
