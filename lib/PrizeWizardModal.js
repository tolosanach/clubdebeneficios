...
export default function PrizeWizardModal({
  ...
  // Rebrand mayo 2026 fase 2: stars migra a violeta brand #7131E1.
  // Points mantiene fucsia #EC4899 (color semántico del sistema).
  const unitColor = commerce?.prog_type === 'stars' ? '#7131E1' : '#EC4899'
