...
const TONES = {
  // Default: estilo neutral / discreto que NO compite con los botones
  // cliqueables (que ahora son outline violeta). El cartel se lee como
  // "info secundaria" — fondo casi imperceptible, ícono "?" gris translúcido,
  // texto en gris medio. Solo el chevron sutil indica que se puede expandir.
  default: {
