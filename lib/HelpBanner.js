...
const TONES = {
  // Default: cartel neutral / discreto que no compite con los botones
  // cliqueables grandes. El TEXTO va en gris para no llamar la atención,
  // pero el ÍCONO "?" se mantiene violeta de marca para que se reconozca al
  // toque como "esto es info / ayuda". Fondo del cartel casi imperceptible.
  default: {
    border: '1px solid rgba(255,255,255,0.08)',
    bg:     'rgba(255,255,255,0.025)',
    iconBg: 'linear-gradient(135deg, #7C3AED 0%, #A855F7 50%, #BD4BF8 100%)',
    iconShadow: '0 3px 10px rgba(168,85,247,0.30)',
    iconColor: '#fff',
  ...
  return (
    ...
    >
      <div style={{
        ...
        <Icon size={13} strokeWidth={2.2} color={t.iconColor || '#fff'} />
      </div>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{
          ...
          {title && (
            <strong style={{ color: 'rgba(255,255,255,0.85)', fontWeight: 600, letterSpacing: '0.01em' }}>
              {title}.
            </strong>
          )}
          {title && ' '}
