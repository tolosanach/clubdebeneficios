            ...
            >
              {isActive(slot) && (
                <>
                  ...
                  />
                  {/* Pill de fondo detras del icono cuando el slot esta
                      activo. Mejora la legibilidad del estado activo —
                      sin esto solo cambiaba el color del icono y no se
                      notaba bien sobre el fondo del nav. */}
                  <span
                    aria-hidden
                    style={{
                      position: 'absolute',
