...
// `accent`. Merchant pasa a violeta brand (#6F30DF); client mantiene
// fucsia (#FF199F) que ya estaba alineado.
const ROLE_COLOR = {
  merchant: { solid: '#6F30DF', gradient: '#6F30DF', glow: 'rgba(113,49,225,0.45)' },
  client:   { solid: '#FF199F', gradient: '#FF199F', glow: 'rgba(236,72,153,0.45)' },
}
...
export default function BottomNavV2({
  ...
  const handleSlotTap = (slot) => {
    ...
    if (slot.isSupport) {
      try { window.dispatchEvent(new CustomEvent('clufix:open-support')) } catch {}
      return
    }
        ...
        {active && !isVertical && (
          <span
            ...
            style={{
              ...
              boxShadow: '0 2px 8px rgba(237,213,246,0.35)',
            }}
          />
        )}
        {active && !isVertical && (
          <span
            ...
            style={{
              ...
              width: 44, height: 30,
              borderRadius: 14,
              background: 'rgba(237,213,246,0.12)',
              border: '1px solid rgba(237,213,246,0.22)',
              pointerEvents: 'none',
            }}
          />
        )}
          ...
          <>
            ...
            <span
              ...
              style={{
                ...
                borderRadius: 10,
                background: 'rgba(237,213,246,0.15)',
                pointerEvents: 'none',
              }}
            />
          </>
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            border: 'none',
            borderRadius: 12,
            background: isClient ? roleColor.gradient : '#EDD5F6',
            color: isClient ? '#fff' : '#220033',
            fontSize: 13.5,
            fontWeight: 600,
            letterSpacing: '0.005em',
            cursor: 'pointer',
            boxShadow: isClient ? `0 4px 14px ${roleColor.glow}` : '0 4px 14px rgba(34,0,51,0.18)',
            marginBottom: 10,
            fontFamily: FN,
        ...
        >
          {isClient
            ...
            : <ScanLine size={18} color="#220033" strokeWidth={1.9} />}
