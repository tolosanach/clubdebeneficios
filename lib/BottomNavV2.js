    ...
    return (
      <button
        ...
        style={{
          ...
          gap: isVertical ? 12 : 3,
          padding: isVertical ? '12px 16px' : 0,
          color: active ? ACTIVE : INACTIVE,
          fontFamily: 'inherit',
          borderRadius: isVertical ? 12 : 0,
          minHeight: isVertical ? 48 : undefined,
        }}
      >
        {active && (
          <span
        ...
        <span style={{ position: 'relative', display: 'inline-flex' }}>
          <slot.Icon
            ...
            color={active ? ACTIVE : INACTIVE}
            style={active ? { filter: `drop-shadow(0 0 6px ${roleColor.glow})` } : undefined}
          />
      ...
      >
        <button
          ...
          style={{
            ...
            cursor: 'pointer',
            boxShadow: `0 8px 24px ${roleColor.glow}`,
            marginBottom: 12,
            fontFamily: FN,
          }}
        >
          ...
          <span>{isClient ? 'Mi QR' : 'Escanear QR'}</span>
        </button>
