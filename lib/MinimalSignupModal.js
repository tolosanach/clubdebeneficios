...
// guardado en sessionStorage `clufix:signupAs`.
//
// Modos:
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: isSelected ? 'rgba(113,49,225,0.20)' : 'transparent',
                  border: 'none',
                  borderRadius: 8,
                  color: '#fff',
          ...
          <div style={{ maxWidth: 440, margin: '0 auto' }}>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: canSubmit && !submitting ? '0 10px 32px rgba(113,49,225,0.40)' : 'none',
                transition: 'opacity 200ms ease, box-shadow 200ms ease',
                marginTop: 4,
              }}>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        color: isPrize ? '#6F30DF' : 'rgba(255,255,255,0.55)',
        ...
        {[0, 1, 2, 3, 4].map(i => {
          ...
          return (
            <Star
              key={i}
              size={20}
              fill={filled ? '#6F30DF' : 'transparent'}
              color={filled ? '#6F30DF' : 'rgba(255,255,255,0.28)'}
              strokeWidth={2}
              style={{
                transform: filled ? 'scale(1)' : 'scale(0.92)',
                transition: 'transform 320ms cubic-bezier(0.34,1.56,0.64,1), fill 320ms ease',
                filter: filled ? 'drop-shadow(0 0 8px rgba(113,49,225,0.55))' : 'none',
              }}
            />
          )
        })}
...
function PointsDemo() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        fontSize: 10.5, fontWeight: 700,
        color: isPrize ? '#FF199F' : 'rgba(255,255,255,0.55)',
        textTransform: 'uppercase', letterSpacing: '.06em',
        marginBottom: 6,
        minHeight: 14,
        transition: 'color 300ms ease',
              ...
              return (
                <button key={s.name} onClick={() => { onToggle(s.name); setCatSearch('') }}
                  style={{
                    ...
                    background: selected ? 'rgba(113,49,225,0.18)' : 'transparent',
              ...
              return (
                <button key={sub.name} onClick={() => onToggle(sub.name)}
                  style={{
                    ...
                    background: selected ? 'rgba(113,49,225,0.20)' : 'rgba(255,255,255,0.05)',
                    border: `1px solid ${selected ? 'rgba(113,49,225,0.50)' : 'rgba(255,255,255,0.10)'}`,
        ...
        <div>
          ...
          <button
            ...
            style={{
              ...
              background: customCat.trim() && !isOtroSelected ? 'rgba(113,49,225,0.20)' : 'rgba(255,255,255,0.05)',
              border: `1px solid ${customCat.trim() && !isOtroSelected ? 'rgba(113,49,225,0.50)' : 'rgba(255,255,255,0.10)'}`,
              color: '#fff', fontFamily: FN, fontSize: 13, fontWeight: 700,
