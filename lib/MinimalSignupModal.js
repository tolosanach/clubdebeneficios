...
import { Check, ChevronLeft, ChevronRight, ChevronDown, X, Store, Star, Coins, AlertTriangle, Search, User as UserIcon, MapPin, Sparkles } from 'lucide-react'
...
export default function MinimalSignupModal({ user, mode = 'client', onComplete, onClose }) {
              ...
              <div style={{ maxWidth: 440, margin: '0 auto' }}>
                <div style={{ marginBottom: 16 }}>
                  ...
                  <input
                    ...
                    placeholder="Café Berlín, Pizzería Don Pedro…"
                    style={inputStyle}
                  />
                </div>
                <CategoryPicker
