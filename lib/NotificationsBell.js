...
export default function NotificationsBell({ bottom = 156, role = 'client', hideButton = false }) {
  ...
  return (
    <>
      {/* Cuando hideButton=true, el botón flotante no se renderiza —
          NotificationsBell vive solo como "drawer + lógica" y otro
          componente (FloatingActionsTab) provee el ícono visible. */}
      {!hideButton && (
        <>
          ...
          {totalUnread > 0 && !open && (
            <button
              ...
              style={{
                ...
                animation: 'bell-cartel-in 360ms cubic-bezier(0.22,1,0.36,1)',
                whiteSpace: 'nowrap',
              }}
      ...
      {open && (
        <>
          ...
          <aside style={{
            ...
            {/* Footer — solo visible en tab Movimientos cuando hay no leídas */}
