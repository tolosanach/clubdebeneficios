...
function HLSVideoPlayer({ src, ...rest }) {
    ...
    <section ref={sectionRef} style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[...integrations, ...integrations, ...integrations, ...integrations].map(({ Icon, label }, i) => (
      ...
      <div style={{
        ...
        <p style={{
          ...
          Sumá puntos, dale beneficios y volvé a tus clientes recurrentes.
        </p>
        ...
        <div style={{
          ...
          <button
            onClick={() => handleSignupCTA('merchant')}
