...
export const SUGGESTED_PRIZES = {
  ...
  'Mueblería': [
    { name: '10% OFF en tu próxima compra', cost: 8 },
    { name: '15% OFF en tu próxima compra', cost: 14 },
    { name: 'Envío gratis dentro de la ciudad', cost: 10 },
  ],
  'Decoración': [
    { name: '10% OFF en tu próxima compra', cost: 6 },
    { name: '20% OFF en tu próxima compra', cost: 12 },
    { name: 'Envoltorio de regalo gratis', cost: 5 },
  ],
  'Florería': [
    { name: '10% OFF en tu próximo ramo', cost: 5 },
  ...
  // que aplican a la mayoría de los negocios. Sacamos "Beneficio
  // especial en tu cumpleaños" porque era ambiguo (qué beneficio?)
  // y no aplicaba bien a rubros como mueblería o ferretería. Quien
  // quiera premio de cumpleaños lo carga a mano con detalle.
  '_default': [
    { name: '10% OFF en tu próxima compra', cost: 6 },
    { name: '20% OFF en tu proxima compra', cost: 10 },
