...
export default function FloatingActionsTab() {
  ...
  function openNotifications(e) {
    e?.stopPropagation?.()
    collapseNow()
    window.dispatchEvent(new CustomEvent('benefix:open-notifications'))
  }

  function openSupport(e) {
    e?.stopPropagation?.()
    collapseNow()
    window.dispatchEvent(new CustomEvent('benefix:open-support'))
  }
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: expanded
          ? '0 12px 32px rgba(168,85,247,0.45), inset 0 0 0 1px rgba(255,255,255,0.15)'
          : '-4px 0 18px rgba(168,85,247,0.55), inset 0 0 0 1px rgba(255,255,255,0.12)',
        border: 'none',
        ...
        {unread > 0 && (
          <span
            style={{
              ...
              borderRadius: 99,
              // Fucsia de marca con gradient sutil para volumen.
