            ...
            <>
              ...
              {form.img_url ? (
                ...
                <label htmlFor="profile-wizard-logo-input" style={{
                  ...
                  border: '2px dashed rgba(189,75,248,0.36)',
                  borderRadius: 22,
                  padding: '40px 20px',
                ...
                {Array.from({ length: 5 }).map((_, i) => {
                  ...
                  return (
                    <label
                      ...
                      style={{
                        aspectRatio: '1/1',
                        background: isNext ? 'rgba(189,75,248,0.06)' : 'rgba(255,255,255,0.02)',
                        border: `2px dashed ${isNext ? 'rgba(189,75,248,0.32)' : 'rgba(255,255,255,0.08)'}`,
                        borderRadius: 14,
                        display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
        ...
        {kind === 'inline' ? (() => {
          ...
          <button
            ...
            style={{
              ...
              fontFamily: FN, fontSize: 14, fontWeight: 800,
              cursor: 'pointer',
              boxShadow: '0 8px 28px rgba(189,75,248,0.40)',
              display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
            }}>
            {cfg.cta}
        ...
        {selected.map(c => (
          <button
            ...
            style={{
              ...
              background: 'rgba(189,75,248,0.20)',
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        background: isSel ? 'rgba(189,75,248,0.20)' : 'transparent',
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: isSel ? 'rgba(189,75,248,0.22)' : 'rgba(255,255,255,0.05)',
                    border: `1px solid ${isSel ? 'rgba(189,75,248,0.50)' : 'rgba(255,255,255,0.10)'}`,
                    color: '#fff', fontFamily: FI, fontSize: 13, fontWeight: 600,
  ...
  return (
    <>
      <div style={{
        ...
        <Star size={18} color="#8B5CF6" strokeWidth={2.2} style={{ flexShrink: 0, marginTop: 1 }} />
          ...
          return (
            <button
              ...
              style={{
                ...
                border: `1px solid ${active ? 'rgba(139,92,246,0.50)' : 'rgba(255,255,255,0.10)'}`,
                color: '#fff', fontFamily: FI, fontSize: 12.5, fontWeight: 600,
                cursor: 'pointer',
              }}>
              ${amount.toLocaleString('es-AR')}
              {active && <Check size={11} color="#8B5CF6" strokeWidth={2.6} style={{ marginLeft: 5, verticalAlign: '-1px' }} />}
            </button>
          )
        })}
      </div>
  ...
  return (
    <button
      ...
      style={{
        ...
        background: active ? 'rgba(189,75,248,0.14)' : 'rgba(255,255,255,0.04)',
        border: `1.5px solid ${active ? 'rgba(189,75,248,0.50)' : 'rgba(255,255,255,0.10)'}`,
        cursor: 'pointer',
        display: 'flex', alignItems: 'flex-start', gap: 10,
        transition: 'background 180ms ease, border 180ms ease',
      }}>
      <div style={{
        width: 18, height: 18, borderRadius: '50%',
        border: `2px solid ${active ? '#BD4BF8' : 'rgba(255,255,255,0.25)'}`,
        background: active ? '#BD4BF8' : 'transparent',
        display: 'flex', alignItems: 'center', justifyContent: 'center',
        flexShrink: 0, marginTop: 2,
      }}>
        {active && <Check size={11} color="#fff" strokeWidth={3} />}
